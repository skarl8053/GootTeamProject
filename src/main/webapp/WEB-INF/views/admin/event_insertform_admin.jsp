        ...
        <form action="event/insert" onsubmit="return eventInsert()" method="post" enctype="multipart/form-data">
			...
			<table>
				...
				<tr>
					<td>이벤트 진행 여부</td>
					<td>
						<span id="event_status">이벤트 기간을 설정해주세요</span>
					</td>
				</tr>
                <tr>
                    <td><br><br></td>
                ...
                <tr>
					...
					<td>
						<ul class="eventlist">
							<li>
                                <textarea name="event_intro" id="event_intro" class="event_textarea" cols="92" rows="5"></textarea>
                            </li>
						</ul>
					</td>
				</tr>
                ...
                <tr>
					...
					<td>
						<ul class="eventlist">
							<li>
                                <textarea name="event_content" id="event_content" class="event_textarea" cols="92" rows="5"></textarea>
                            </li>
						</ul>
					</td>
				</tr>
					...
					<td>
						<ul class="eventlist">
							<li class="value" id="filebox">
									<input id="upload-name" placeholder="첨부파일"  readonly autocomplete="off">
                ...
                <tr>
					...
					<td>
						<ul class="eventlist">
							<li class="value" id="filebox">
									<input id="upload-name2" placeholder="첨부파일"  readonly autocomplete="off">
                ...
                <tr>
                    <td></td>
                    <td><img id="event_banner_img2"></td>
                </tr>
                <tr>
                    <td><br><br></td>
                    <td><br><br></td>
