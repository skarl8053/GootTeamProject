...
public interface IDao_Review_user {
	...
	public ArrayList<DTO_StayDetail_user> rwriteview(String s_no);
...
//	public void rwrite(String m_no, String s_no, String r_no, String photo_url,String review_rate, String review_content);
	public void rwrite(String m_no, String s_no,  String photo_url,String review_rate, String review_content);
